...
import 'package:aggregator/Screens/analytics_screen.dart';
...
class _WebViewExampleState extends State<WebViewExample> {
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          /*  onPageFinished: (String url) {
              ...
              if (url.contains("https://webhookandredirecturl.onrender.com/return-url")) {
                if (mounted) {
                //  Navigator.pop(context);
                  Provider.of<TransactionProvider>(context, listen: false)
                      .fetchStatusCheck().then((_) => Navigator.pop(context));
                }
              }
            },*/
          onPageFinished: (String url) {
  ...
  isForMainFrame: ${error.isForMainFrame}
          ...
          onNavigationRequest: (NavigationRequest request) {
            print(
                "Step1+++++++++++++++++++++++__________(((()))${request.isMainFrame}");
            print(
                "Step2+++++++++++++++++++++++__________(((()))${request.url}");
